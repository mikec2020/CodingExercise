...
namespace InvestmentPerformance.WebApi.Controllers
{
    ...
    public class UserInvestmentDetailsController : ControllerBase
    {
        ...
        private readonly IGetInvestmentDetails _service;

        public UserInvestmentDetailsController(ILogger<UserInvestmentDetailsController> logger, IGetInvestmentDetails service)
        {
            _logger = logger;
            _service = service;
        }
